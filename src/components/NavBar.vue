    ...
    <div>
        <div class="flex justify-between items-center px-3">
            <div class="flex items-center">
                ...
                <!-- svg : moon -->
                <svg v-if="props.toggle" class="ml-2 svg-moon cursor-pointer" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" viewBox="0 0 24 24" @click="toggleChange">
                    <path
                ...
                <!-- svg : sun -->
                <svg v-else class="ml-2 svg-sun cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="flex gap-4">
                <RouterLink v-for="path in paths" :key="path.name" :to="path.path" class="router flex items-center">
